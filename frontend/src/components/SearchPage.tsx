...
const SearchPage: React.FC = () => {
    ...
    return (
        <div className="container mx-auto px-4 sm:px-6 py-12 min-h-screen bg-gray-50">
            <h2 className="text-3xl font-semibold text-gray-800 mb-8 text-center">{t("titles.search_results")} "{query}"</h2>
